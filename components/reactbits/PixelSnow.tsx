...
// Adaptado de React Bits "Pixel Snow" (https://reactbits.dev/backgrounds/pixel-snow,
// licencia MIT). El shader es identico al original (raymarching de copos
// sobre una grilla de voxeles) -- se conserva completo, a diferencia de
// otros componentes de esta carpeta no se le recorta nada porque es un
// efecto decorativo autocontenido, no una interaccion de UI. Lo unico
// que se adapta son los props por defecto: el blanco original queda
// invisible sobre el fondo claro del sitio (--background: #f8fafc), asi
// que se usa el teal de marca con densidad baja.
